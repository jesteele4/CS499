Below is an updated version of your **README.md** to reflect the new **non-RTOS** design, **modular components**, and the improved **PWM and Timer logic** in your project.
